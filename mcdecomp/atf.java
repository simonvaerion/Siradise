...
extends awf {
    ...
    protected String a(String $$0) {
        if (((String)$$0).startsWith(d)) {
            $$0 = "minecraft:" + ((String)$$0).substring(d.length());
        }
        return a.getOrDefault($$0, (String)$$0);
    }
}
