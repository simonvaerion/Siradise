...
extends DataFix {
    ...
    private static final Map<String, String> b = (Map)DataFixUtils.make((Object)Maps.newHashMap(), $$0 -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        OpticFinder $$2 = DSL.fieldFinder((String)"id", axd.a());
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix" + this.getOutputSchema().getVersionKey(), $$0, $$4 -> {
            ...
            if ($$5.isPresent() && Objects.equals(((Pair)$$5.get()).getSecond(), this.a) && ($$8 = ($$7 = ($$6 = $$4.getOrCreateTyped($$3)).getOrCreateTyped($$42)).getOptional($$2)).isPresent()) {
                return $$4.set($$1, (Object)Pair.of((Object)avw.s.typeName(), (Object)b.getOrDefault($$8.get(), "minecraft:pig_spawn_egg")));
            }
            return $$4;
        });
    }
